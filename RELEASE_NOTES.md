...
## Unreleased — Copilot instructions and safer skill management

These changes are proposed in [PR #4](https://github.com/dprakash2101/dotnet-production-agent-skills/pull/4). They have not been published to npm. The current package version remains `0.1.1` until a release is prepared.
